                                ...
                                <div class="col-7 justify-content-center ms-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center ms-5 me-5 ps-5 pe-5">
                                            ...
                                            <p class="p-1 fw-bold"><?php echo htmlspecialchars($data['office'], ENT_QUOTES, 'UTF-8'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col text-start d-flex align-items-center p-0 m-0">
                                    <h6 class="fw-bolder">Feedback No.&nbsp;<?php echo htmlspecialchars($data['feedback_number'], ENT_QUOTES, 'UTF-8'); ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table border-0 ">
                            <tr class="border-0 d-flex justify-content-around">
                                <td class="m-0 h6 border-0 d-flex flex-column text-start">
                                    ...
                                    <p class="p-1"><?php echo htmlspecialchars($data['job_service'], ENT_QUOTES, 'UTF-8'); ?></p>
                                </td>
                                <td class="m-0 h6 border-0 d-flex flex-column text-start">
                                    <label for="employee" class="fst-italic">Name of Employee: </label>
                                    <p class="p-1"><?php echo $user['requesting_official']; ?></p>
                                </td>
                                <td class="m-0 h6 border-0 d-flex flex-column text-start">
                                    <label for="date" class="fst-italic">Date: </label>
                                    <p class="p-1"><?php echo htmlspecialchars(date("F j, Y", strtotime($data['feedback_date'])), ENT_QUOTES, 'UTF-8'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
