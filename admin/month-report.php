<?php 
// ADMIN: VIEW MONTHLY REPORT before download
...
if (isset($_POST['month-report'])) {
    ...
    $start = $_POST['this-month'] . "-" . $_POST['this-year'];
    $end = $_POST['this-month'] . "-" . $_POST['this-year'];

    $from = date("Y-m-01", strtotime($start));
    $to = date("Y-m-t", strtotime($end));

    $evaluation_period = date("F Y", strtotime($start));
                ...
                <form method="post" action="../config/generate-reports.php">
                    ...
                    <div class="container ps-5 pe-5 mb-3">
                        <div class="text-center">
                            <p class="h5 mb-3 mt-4">OFFICE OF THE UNIVERSITY PRESIDENT</p>
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-center ms-5 me-5 ps-5 pe-5">
                                ...
                                <input value="<?php echo $evaluation_period; ?>" name="evaluation" id="evaluation" class="p-0 m-0 border-0 fw-bold form-control text-center">
                            </div>
                    ...
                    <div class="container ps-5 pe-5 mb-3">
                        ...
                        <div class="container mt-3 pt-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <button name="get-month-report" id="get-month-report" class="btn btn-primary fsz">Generate Report</button>
                            </div>
                        </div>
